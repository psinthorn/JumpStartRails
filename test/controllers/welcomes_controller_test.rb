...
class WelcomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create welcome" do
    assert_difference('Welcome.count') do
      post welcomes_url, params: { welcome: { body: @welcome.body, status: @welcome.status, subbody: @welcome.subbody, subtitle: @welcome.subtitle, title: @welcome.title } }
    end
  ...
  test "should update welcome" do
    patch welcome_url(@welcome), params: { welcome: { body: @welcome.body, status: @welcome.status, subbody: @welcome.subbody, subtitle: @welcome.subtitle, title: @welcome.title } }
